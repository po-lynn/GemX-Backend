-- One-time setup: placeholder "GemX" system user used as the chat sender for
-- automated notifications (e.g. monthly bonus points granted).
...
INSERT INTO "user" (
  ...
  'sys-gemx-notifications',
  'GemX',
  'notifications@system.gemxpremium.internal',
