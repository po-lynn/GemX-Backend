...
export default function PrecautionTagsLoading() {
  return (
    <div className="space-y-4">
      <div className="space-y-1.5">
        <SkBlock w={140} h={22} color="#f59e0b" opacity={0.18} rounded="md" />
        <SkBlock w={220} h={11} color="#f59e0b" opacity={0.10} rounded="sm" />
      </div>
      <div className="flex items-center gap-2">
        ...
        <div className="ml-auto">
          <SkBlock w={130} h={36} color="#f59e0b" opacity={0.12} rounded="lg" />
        </div>
      </div>
