...
export default async function AdminMyPointsPage({ searchParams }: Props) {
  await connection()
    ...
    <div className="py-2">
      <div className="lv-pagehead">
        <div>
          ...
          <p className="lv-subhead">Your point balance, top-ups, and spending history.</p>
        </div>
      </div>
      ...
      <UserPointBalanceHeader
        ...
        purchaseHref="/admin/my-points/purchase"
      />
