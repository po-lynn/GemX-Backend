...
const quickActions: QuickAction[] = [
  ...
  { href: "/admin/credit",                         label: "Credit",     icon: ShoppingBag,   color: "#8b5cf6", featureKey: FEATURE_KEYS.CREDIT_PACKAGES },
  { href: "/admin/messages",                       label: "Messages",   icon: MessageSquare, color: "#a855f7", featureKey: FEATURE_KEYS.MESSAGES },
  { href: "/admin/collector-piece-show-requests",  label: "Collector",  icon: Eye,           color: "#06b6d4", featureKey: FEATURE_KEYS.COLLECTOR_REQUESTS },
  { href: "/admin/chat-dashboard",                 label: "Chat",       icon: MessageSquare, color: "#0ea5e9", featureKey: FEATURE_KEYS.CHAT_DASHBOARD },
]
      ...
      <StaggerList className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        {showProducts && (
          <Link
            ...
            style={{ backgroundImage: "radial-gradient(circle at 100% 0%, rgba(139,92,246,0.10) 0%, transparent 40%)" }}
          >
        ...
        {showUsers && (
          <Link
            href="/admin/users"
            className="group relative overflow-hidden rounded-2xl bg-card p-5 shadow-sm ring-1 ring-border/60 transition-all hover:shadow-md hover:-translate-y-0.5 active:translate-y-0"
            style={{ backgroundImage: "radial-gradient(circle at 100% 0%, rgba(59,130,246,0.10) 0%, transparent 40%)" }}
          >
            <div className="relative flex items-start justify-between">
        ...
        {showCollector && (
          <Link
            ...
            style={{ backgroundImage: "radial-gradient(circle at 100% 0%, rgba(245,158,11,0.10) 0%, transparent 40%)" }}
          >
            {pendingRequests > 0 && (
        ...
        {showPayments && (
          <Link
            ...
            style={{ backgroundImage: "radial-gradient(circle at 100% 0%, rgba(16,185,129,0.10) 0%, transparent 40%)" }}
          >
            {pendingPoints > 0 && (
              <span className="absolute right-4 top-4 flex h-2 w-2">
